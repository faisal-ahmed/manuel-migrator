    ...
    if ($('#fileupload').length) {
        new AjaxUpload('fileupload', {
            ...
            onSubmit: function (file, ext) {
                if (validateFileExt(ext) != true) {
                    $('.fileupload #uploadmsg').text("File type doesn't match. Please select Microsoft Excel files only.");
            ...
            onComplete: function (file, response) {
                ...
                $('#uploaded_file_name').attr('value', fileName);
                $('.fileupload #uploadmsg').removeClass('loading').text(message);
